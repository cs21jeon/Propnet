...
| 서비스 | 로컬 경로 | 플랫폼 | 서버 포트 | systemd 서비스명 | 서버 경로 |
|--------|-----------|--------|-----------|------------------|-----------|
| **API Server** | (서버만) | API | 8000 | `goldenrabbit-api` | `/backend/api/` |
| **Property Manager** | (서버만) | API | 5000 | `property-manager` | `/backend/property-manager/` |
| **Propedia** | `propedia/` | Flutter 앱 + 웹(PWA) | 5010 | `proppedia` | `/backend/proppedia/` |
| **PropSheet** | `propsheet/` | 웹 (HTMX/Alpine.js) | 5020 | `propsheet` | `/backend/propsheet/` |
| **Proptalk** | `proptalk/` | Flutter 앱 | 5030 | `proptalk` | `/chat_stt/server/` |

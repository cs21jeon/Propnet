...
| 화면 | API 엔드포인트 | 비고 |
|------|---------------|------|
| 지도 마커 데이터 | GET /propsheet/api/propsheet/map-data | PropSheet DB (2026-03-25 전환) |
| 조건 검색 | POST /propsheet/api/propsheet/search-map | PropSheet DB (2026-03-25 전환) |
| 매물 상세 | GET /propsheet/api/propsheet/property-detail?id= | PropSheet DB (2026-03-25 전환) |
| 카테고리별 | GET /api/category-properties?view= | 아직 Airtable API (전환 예정) |
